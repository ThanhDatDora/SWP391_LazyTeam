/**
 * InstructorChatButton Component
 * Floating chat button for instructors - Navigate to chat page
 */
...
export default function InstructorChatButton() {
  ...
  // Don't show if not logged in or not instructor
  if (!authState.user || authState.user.roleId !== 2) {
    return null;
  }
