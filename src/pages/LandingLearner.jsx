...
const LandingLearner = () => {
  ...
  // Use optimized hooks instead of manual state management
  const { data: coursesData, loading: coursesLoading } = useCourses({ limit: 12 });
        ...
        <div className="flex items-center justify-between">
          ...
          {isRecent && (
            <div className="flex items-center text-sm text-green-600">
              ...
              <span>{course.progress || 45}% complete</span>
            </div>
          )}
        </div>
      </CardContent>
