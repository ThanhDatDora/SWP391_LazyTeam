  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (activeTab === 'login') {
        ...
        console.log('🎯 Login result.success:', result.success, typeof result.success);
        console.log('🎯 Login result.redirect:', result.redirect);
        
        if (result.success) {
          // AuthContext will handle redirect based on role
          console.log('✅ Login successful, AuthContext will handle redirect');
          // Don't navigate here - let AuthContext's setTimeout handle it
          return;
        } else {
